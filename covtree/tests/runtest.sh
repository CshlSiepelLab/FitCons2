...
dt1="./1-basic"; dt1=`readlink -f "$dt1"`
echo -e "\n\n==============================================================================================================================================\n"
echo -e "`date` Configuring covtree Demo 1: Simple decomposition using CDS, RNA-seq and DNase-seq covaraites, for E003,E116,E122 (h1hesc, gm12878, HUVEC).\n"
echo -e "\n\t Working directory:\n\t\t${dt1} \n"
...
#ctargs="-v 6 -iprocs 3 -scts E003,E116,E122 -erecurse 0 -minbits 100 -hcpos 10000 -maxdepth 5 -ipriors 0.07342932116859754443,0.00021737936739721811,0.64059032649056757425,347,125851001.911690,125851025.166302" # explicit priors, debug mode
ctargs="-v 1 -iprocs 3 -scts E003,E116,E122 -erecurse 0 -minbits 100 -hcpos 10000 -maxdepth 5 "  # implicit priors, drawn from hg19

fdb="${ddb}/covdef.test1-simple.txt"
...
db="../../.."
dcov="${db}/covtree"
dcovdb="${dcov}/db/1-test1-simple"
fcovdb="${dcovdb}/covdef.test1-simple.txt"
fcov="${dcov}/bin/covtree"
dins="${db}/Insight2"
fins="${dins}/bin/Insight2"
dinsdb="${dins}/db"
...
"${fcov}" "${fcovdb}" "${fins}" "${dinsdb}" "${dout}" ${ctargs}
