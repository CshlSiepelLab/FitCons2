...
dt1="./1-basic"; mkdir -p "$dt1"; dt1=`readlink -f "$dt1"`
echo -e "\n\n==============================================================================================================================================\n"
...
surl='http://nextgen.cshl.edu/~bgulko/research/covtree/db/FitCons2/1-test1-simple/covtree-test1-DB.tar'
if [[ -s "$fdb" ]]; then
