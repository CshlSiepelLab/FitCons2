...
### Installation Guide:
 - Instructions:
   ...
   - Download [Insight2 database](http://nextgen.cshl.edu/~bgulko/research/Insight2/db/FitCons2/Insight2DB.tar) (about 0.5GB) and expand files using ```unstarch``` and ```gunzip``` (expands to about 3.2GB). The Insight2 database directory (`didb`) will be **`FitCons2/Insight2/Insight2DB`** <br>
